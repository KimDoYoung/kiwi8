...
class StkTradeHistoryUpdate(BaseModel):
    ...
    ymd: str | None = Field(None, description="거래일 (YYYYMMDD 형식)")
    note: str | None = Field(None, description="매매 기록")
...
class StkTradeHistoryFilter(BaseModel):
    ...
    stk_nm_like: str | None = Field(None, description="종목명 검색어")
    note_like: str | None = Field(None, description="매매 기록 검색어")
